...
It contains:  
- Terraform scripts for deploying two VSIs in an EXISTNG VPC with Subnet and Security Group configs. The VSIs scope: one for the DB2 instance and one for ASCS and PAS instances.
...
DB-PROFILE		= "bx2-4x16"
DB-IMAGE		= "ibm-redhat-7-6-amd64-sap-applications-x" # For any manual change in the terraform code, you have to make sure that you use a certified image based on the SAP NOTE: 2927211.

# SAP APPs VSI variables:
APP-HOSTNAME	= "sapnwapp"
APP-PROFILE		= "bx2-4x16"
APP-IMAGE		= "ibm-redhat-7-6-amd64-sap-applications-x" # For any manual change in the terraform code, you have to make sure that you use a certified image based on the SAP NOTE: 2927211.
```
