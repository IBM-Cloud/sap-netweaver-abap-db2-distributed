...
## 1.1 Executing the deployment of **Three Tiers SAP Netweaver ABAP Stack with DB2** from GUI (IBM Cloud Schematics)
...
kit_db2_dir | Path to DB2 LUW 11.5 MP6 FP0 SAP2 Linux on x86_64 64bit dir | The archive downloaded from SAP Support Portal must be extracted and the path provided to this parameter must contain LABEL.ASC file
...
- Allow inbound SSH traffic (TCP for port 22) from IBM Schematics Servers.
 ...
 - `integration*.tf & generate*.tf` - contain the integration code that makes the SAP variabiles from Terraform available to Ansible.
...
## 1.2 Executing the deployment of **Three Tiers SAP Netweaver ABAP Stack with DB2** from CLI
