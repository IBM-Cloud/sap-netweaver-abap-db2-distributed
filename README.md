...
ID_RSA_FILE_PATH | The id_rsa private key file path in OpenSSH format with 0600 permissions. It is recommended to be changed after the SAP deployment. <br /> Sample values:  "ansible/id_rsa_abap_db2_dst" , "~/.ssh/id_rsa_abap_db2_dst" , "/root/.ssh/id_rsa".
