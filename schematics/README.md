...
- Terraform scripts for deploying in an **existing  VPC** the  Subnet, Security Group with rules, SAP volumes and 2 VSIs: one for the DB2 instance and one for ASCS and PAS instances.
- Bash scripts to install the prerequisites for the SAP VSIs deployment and the integration toward to **SAP Netweaver 7.5** with **DB2 10.5FP7** installation using IBM Schematics GUI in a single step.
...
## VSI Configuration
The VSIs are deployed with Red Hat Enterprise Linux 7.6 for SAP Applications (amd64). The SSH keys are configured to allow root user access.
...
RESOURCE_GROUP | An EXISTING Resource Group for VSI and volumes. <br /> Default value: "Default". The list of Resource Groups is available [here](https://cloud.ibm.com/account/resource-groups).
...
DB-PROFILE |  The profile used for the DB VSI. A list of profiles is available [here](https://cloud.ibm.com/docs/vpc?topic=vpc-profiles) <br /> Default value: "bx2-4x16"
DB-IMAGE | The OS image used for the VSI. A list of images is available [here](https://cloud.ibm.com/docs/vpc?topic=vpc-about-images).<br /> Default value: ibm-redhat-7-6-amd64-sap-applications-3
...
APP-PROFILE |  The profile used for the APP VSI. A list of profiles is available [here](https://cloud.ibm.com/docs/vpc?topic=vpc-profiles) <br /> Default value: "bx2-4x16"
APP-IMAGE | The OS image used for the APP VSI. A list of images is available [here](https://cloud.ibm.com/docs/vpc?topic=vpc-about-images).<br /> Default value: ibm-redhat-7-6-amd64-sap-applications-3
